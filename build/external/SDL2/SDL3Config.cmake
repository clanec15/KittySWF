...
macro(find_sdl3_static_dependencies)
  ...
  if(PkgConfig_FOUND)
    pkg_check_modules(PC_PULSEAUDIO QUIET IMPORTED_TARGET libpulse>=0.9.15)
    if(NOT PC_PULSEAUDIO_FOUND)
      set(SDL3_SDL3-static_FOUND OFF)
    endif()
    pkg_check_modules(PC_SNDIO QUIET IMPORTED_TARGET sndio)
    if(NOT PC_SNDIO_FOUND)
      set(SDL3_SDL3-static_FOUND OFF)
    endif()
    pkg_check_modules(PC_LIBDRM QUIET IMPORTED_TARGET libdrm)
    if(NOT PC_LIBDRM_FOUND)
      set(SDL3_SDL3-static_FOUND OFF)
    endif()
    ...
    pkg_check_modules(PC_WAYLAND QUIET IMPORTED_TARGET wayland-client>=1.18 wayland-egl wayland-cursor egl xkbcommon>=0.5.0)
    if(NOT PC_WAYLAND_FOUND)
      set(SDL3_SDL3-static_FOUND OFF)
    endif()
    pkg_check_modules(PC_LIBDECOR QUIET IMPORTED_TARGET libdecor-0>=0.2.0)
    if(NOT PC_LIBDECOR_FOUND)
      set(SDL3_SDL3-static_FOUND OFF)
    endif()
  else()
    set(SDL3_SDL3-static_FOUND OFF)
